...
cat frick-zeri.tsv | node zeri/gen-known-map.js zeri/fzeri_F_2014_02_10_105226.xml >> known-map.csv

echo "Generating 16thC Frick-Zeri known artwork mapping..."
cat frick-zeri.tsv | node zeri/gen-known-map.js zeri/fzeri_F_2014_10_10_103330.xml >> known-map.csv